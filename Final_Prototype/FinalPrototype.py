...
def Top_Down_View():
    ...
    if(top_down_view==False):
        ...
        if(currently_parked==True):
            the_canvas.create_image(620,150,image=Blue_Car)
            the_canvas.create_rectangle(430,-1,791,90,fill="#e8c79d")
        if(currently_parked==False):
            the_canvas.create_rectangle(550,-1,691,250,fill="grey")
            the_canvas.create_rectangle(671,-1,681,250,fill="#e9c316")
            the_canvas.create_rectangle(560,-1,571,50,fill="#e9c316")
            the_canvas.create_rectangle(560,100,571,150,fill="#e9c316")
            the_canvas.create_rectangle(560,200,571,250,fill="#e9c316")


            the_canvas.create_image(620,10,image=Red_Car)
            if(Distance_Selection==1):
                the_canvas.create_image(620,100,image=Blue_Car)
            if(Distance_Selection==2):
                the_canvas.create_image(620,150,image=Blue_Car)
            if(Distance_Selection==3):
                the_canvas.create_image(620,200,image=Blue_Car)
...
Red_Car = PhotoImage(file = "Prototype/Red_Car.png")
Blue_Car = PhotoImage(file = "Prototype/Blue_Car.png")
